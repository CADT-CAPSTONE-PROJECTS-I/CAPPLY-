...
from .views import  list_scholarship,search_tag, scholarship_detail, scrape_data,edit_profile,form_view,generate_cv_pdf,cv, change_password, create_reply, create_comment, add_to_favorite, favorite_list,favorite_delete
urlpatterns = [
